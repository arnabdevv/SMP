...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Login functionality is disabled in static mode. Would have logged in as ${selectedRole}.`);
  };
        ...
        <Card className="shadow-xl">
          <CardContent className="p-8">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-semibold text-foreground">School Management</h1>
