...
import { ArrowLeft, Plus, Edit, Trash2, GraduationCap, CalendarIcon, Filter } from 'lucide-react';
...
const students = [
  {
    ...
    user: { name: 'Alice Johnson', email: 'alice@example.com', phone: '555-0101' },
    class: { id: 'c1', name: 'Class 10A' },
    batch: { id: 'b1', name: '2024-2025' },
  },
  {
    id: '2',
    studentId: 'STU2024002',
    rollNumber: '102',
    dateOfBirth: '2008-08-15T00:00:00.000Z',
    address: '456 Oak Ave, Anytown, USA',
    parentName: 'Jane Smith',
    parentPhone: '555-5678',
    user: { name: 'Bob Williams', email: 'bob@example.com', phone: '555-0102' },
    class: { id: 'c2', name: 'Class 10B' },
    batch: { id: 'b1', name: '2024-2025' },
  },
];
...
const classes = [
  ...
  { id: 'c3', name: 'Class 11A' },
];

const batches = [
  { id: 'b1', name: '2024-2025' },
  { id: 'b2', name: '2023-2024' },
];
...
const ManageStudents = () => {
  ...
  const handleDelete = (studentId) => {
    alert(`Delete action for student ${studentId} not available in static mode.`);
  };
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2">Add, edit, and manage student accounts</p>
            </div>
          </div>
          
          <Dialog open={isCreateDialogOpen || !!editingStudent} onOpenChange={(open) => {
            if (!open) {
              setIsCreateDialogOpen(false);
              resetForm();
            }
            ...
            <DialogTrigger asChild>
              <Button onClick={() => setIsCreateDialogOpen(true)} data-testid="button-add-student">
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input {...field} placeholder="e.g., STU2024001" data-testid="input-student-id" />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Assign Class (optional)</FormLabel>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel>Assign Batch (optional)</FormLabel>
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                ...
                <TableBody>
                  {students?.map((student, index) => (
                    <TableRow key={student.id}>
                      <TableCell>
                        <div className="flex items-center">
                          <div className={`w-10 h-10 ${getRandomColor(index)} rounded-full flex items-center justify-center text-white font-medium mr-3`}>
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground" data-testid={`student-roll-${index}`}>
